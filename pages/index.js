      ...
      <section>
        <div className='tempo-pay--content'>
          ...
          <div className='tempo-pay--cta'>
            <p>Full website coming soon <a href="mailto:contact@tempopay.com">contact@tempopay.com</a></p>
            <button><a href="mailto:contact@tempopay.com" target="_blank">Contact</a></button>
          </div>
        </div>
      </section>
